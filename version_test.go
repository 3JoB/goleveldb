...
func TestVersionReference(t *testing.T) {
	...
	for i, x := range []struct {
		...
		{
			add:    []testFileRec{{level: 0, num: 1}, {level: 0, num: 2}},
			del:    nil,
			expect: map[int64]int{1: 1, 2: 1},
			failed: false,
		},
		{
			add:    []testFileRec{{level: 0, num: 3}, {level: 0, num: 4}},
			del:    []testFileRec{{level: 0, num: 1}},
			expect: map[int64]int{2: 1, 3: 1, 4: 1},
			failed: false,
		},
		{
			add:    []testFileRec{{level: 0, num: 1}, {level: 0, num: 5}, {level: 0, num: 6}, {level: 0, num: 7}},
			del:    []testFileRec{{level: 0, num: 2}, {level: 0, num: 3}, {level: 0, num: 4}},
			expect: map[int64]int{1: 1, 5: 1, 6: 1, 7: 1},
			failed: false,
		},
		{
			add:    nil,
		...
		},
		{
			add:    []testFileRec{{level: 0, num: 1}, {level: 0, num: 5}, {level: 0, num: 6}, {level: 0, num: 7}},
			del:    nil,
			expect: map[int64]int{1: 2, 5: 2, 6: 2, 7: 2},
			failed: false,
		},
		{
			add:    nil,
			del:    []testFileRec{{level: 0, num: 1}, {level: 0, num: 5}, {level: 0, num: 6}, {level: 0, num: 7}},
			expect: map[int64]int{1: 1, 5: 1, 6: 1, 7: 1},
			failed: false,
		},
		{
			add:    []testFileRec{{level: 0, num: 0}},
			del:    []testFileRec{{level: 0, num: 1}, {level: 0, num: 5}, {level: 0, num: 6}, {level: 0, num: 7}},
