...
var readBytesTests = []struct {
	...
	{buffer: "", delim: 0, expected: []string{""}, err: io.EOF},
	{buffer: "a\x00", delim: 0, expected: []string{"a\x00"}, err: nil},
	{buffer: "abbbaaaba", delim: 'b', expected: []string{"ab", "b", "b", "aaab"}, err: nil},
	{buffer: "hello\x01world", delim: 1, expected: []string{"hello\x01"}, err: nil},
	{buffer: "foo\nbar", delim: 0, expected: []string{"foo\nbar"}, err: io.EOF},
