...
var cases = []struct {
	...
	{oldName: nil, name: "000100.log", ftype: TypeJournal, num: 100},
	{oldName: nil, name: "000000.log", ftype: TypeJournal, num: 0},
	{oldName: []string{"000000.sst"}, name: "000000.ldb", ftype: TypeTable, num: 0},
	{oldName: nil, name: "MANIFEST-000002", ftype: TypeManifest, num: 2},
	{oldName: nil, name: "MANIFEST-000007", ftype: TypeManifest, num: 7},
	{oldName: nil, name: "9223372036854775807.log", ftype: TypeJournal, num: 9223372036854775807},
	{oldName: nil, name: "000100.tmp", ftype: TypeTemp, num: 100},
}
...
func TestFileStorage_CreateFileName(t *testing.T) {
	for _, c := range cases {
		if name := fsGenName(FileDesc{Type: c.ftype, Num: c.num}); name != c.name {
